...
import { base, baseSepolia, optimismSepolia, spicy } from "@wagmi/core/chains";
...
const Collections = () => {
  ...
  }, [account.chainId, nativeTokenBalance]);
  ...
  const OGCollection =
    account.chainId === baseSepolia.id
      ...
      : account.chainId === optimismSepolia.id
      ? filteredCollection
      : [];
        ...
        return (
          <>
            ...
            account.chainId === optimismSepolia.id ? (
              ...
              <div>
                Please connect wallet and switch network to Base
